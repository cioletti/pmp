 ...
 */
@Entity
@Table(name = "PMP_CONTRATO_MONITORAMENTO")
public class PmpContratoMonitoramento implements Serializable {
    ...
    @Column(name = "DATA_PRE_ENTREGA")
    private String dataPreEntrega;
    @Column(name = "PERIODO_GARANTIA")
    private Long periodoGarantia;
    
    public PmpContratoMonitoramento() {
    }

    public PmpContratoMonitoramento(Long id) {
        this.id = id;
    }
	...
	public String getDataPreEntrega() {
		return dataPreEntrega;
	}

	public void setDataPreEntrega(String dataPreEntrega) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PmpContratoMonitoramento)) {
            return false;
        }
        PmpContratoMonitoramento other = (PmpContratoMonitoramento) object;
